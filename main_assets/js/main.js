...
*/	
	...
	function contact(name) {
		const template = atob('bWFpbHRvOmluZm9AJW5hbWUlLnNvbHV0aW9ucw');
	  ...
	  function submitForm(event) {
		const url = 'https://formkeep.com/f/a369abf4520b';
